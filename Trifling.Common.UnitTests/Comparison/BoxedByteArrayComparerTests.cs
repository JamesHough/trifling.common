namespace Trifling.Common.UnitTests.Comparison
{
    ...
    public class BoxedByteArrayComparerTests
    {
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenGetHashCode_AndByteArrayEmpty_ThenZero()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
            byte[] a = new byte[0];
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenGetHashCode_AndByteArrayNull_ThenZero()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
            byte[] a = null;
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenDifferentByteArrays_ThenHashCodesDoNotMatch()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenSameByteArrays_ThenHashCodesMatch()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenEquals_AndBothByteArraysEmpty_ThenTrue()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
            byte[] a = new byte[0];
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenEquals_AndBothByteArraysNull_ThenTrue()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
            byte[] a = null;
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenEquals_AndFirstByteArrayEmpty_ThenFalse()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
            byte[] a = new byte[0];
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenEquals_AndFirstByteArrayNull_ThenFalse()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
            byte[] a = null;
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenEquals_AndSecondByteArrayEmpty_ThenFalse()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenEquals_AndSecondByteArrayNull_ThenFalse()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
            byte[] a = new byte[] { 199, 100, 0, 0 };
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenEquals_AndByteArraysDifferInValues_ThenFalse()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
            byte[] a = new byte[] { 199, 100, 0, 0 };
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenEquals_AndByteArraysDifferInLength_ThenFalse()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
            byte[] a = new byte[] { 199, 100, 0, 0 };
        ...
        [TestMethod]
        public void BoxedByteArrayComparerTest_WhenEquals_AndByteArraysDifferInLength2_ThenFalse()
        {
            // ----- Arrange -----
            var comparer = new BoxedByteArrayComparer();
